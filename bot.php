...
if (file_exists(__DIR__ . '/language/default.json')) {
    ...
    $LANG = json_decode('{
        "START": "Merhaba! Bu botu @Sairbey\'e ulaşmak için kullanabilirsiniz. Mesaj/ses/sticker/gif/dosya/fotoğraf atabilirsiniz. Admin\'im bunu en yakın zamanda görüp cevaplıyacaktır.",
